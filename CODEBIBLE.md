...
### 4.1 This File IS the Memory
Claude has no memory between sessions. This file is the memory. Every important decision, pattern, and mistake lives here. Keep it updated.

### 4.2 After Every Correction, Add a Rule
